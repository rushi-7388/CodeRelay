                      ...
                      <div className="flex items-center gap-4 text-sm opacity-80">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-xs">
                            {(session.participants?.length || 0) + 1}/{session.type === "1-on-1" ? "2" : "50"}
                          </span>
                        </div>
                        {((session.type === "1-on-1" && session.participants?.length >= 1) || (session.type === "group" && session.participants?.length >= 49)) && !isUserInSession(session) ? (
